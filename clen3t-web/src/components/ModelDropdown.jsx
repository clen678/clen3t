...
const ModelDropdown = () => {
    ...
    return ( 
        <div className="relative">
            <button className={`bg-primary-background-lighter px-3 py-1 min-w-[160px] hover:bg-primary-background-lighter active:bg-primary-background-light ${!isOpen ? 'rounded-lg' : 'rounded-tl-lg rounded-tr-lg'}`} onClick={handleOpen}>
            ...
            {isOpen && (
                <div className='absolute bg-primary-background-lighter flex flex-col min-w-[160px] items-start border-primary-background-lighter border-[2px] rounded-bl-lg rounded-br-lg' >
